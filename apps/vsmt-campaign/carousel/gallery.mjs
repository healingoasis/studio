...
writeFileSync(new URL('./review.html', import.meta.url), `<title>VSMT Carousels</title>
<style>
  :root{--bg:#faf6ef;--ink:#2a1512;--muted:#6b5550;--line:rgba(92,1,1,0.16);--accent:#2f4670}
  @media (prefers-color-scheme:dark){:root:not([data-theme="light"]){--bg:#1a120e;--ink:#f5ecdf;--muted:#b49f98;--line:rgba(245,236,223,0.18);--accent:#7fa3d8}}
  :root[data-theme="dark"]{--bg:#1a120e;--ink:#f5ecdf;--muted:#b49f98;--line:rgba(245,236,223,0.18);--accent:#7fa3d8}
...
<div class="wrap">
  <h1>Veterinary Spinal Manipulative Therapy<br>Twelve carousels, 72 slides</h1>
  <p class="lede">Twelve carousels, 26 August to 17 September. <strong>29 photographs, each used once</strong>, every source verified distinct from the conference, acupuncture and VMRT campaigns. Two classes open: 2027 Spring and 2027 Fall. 31 facts checked against the VSMT program page on 25 August 2026.</p>
  ${groups}
</div>
`)
