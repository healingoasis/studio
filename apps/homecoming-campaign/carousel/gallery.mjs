...
writeFileSync(new URL('./review.html', import.meta.url), `<title>Conference Carousels</title>
<style>
  :root{--bg:#faf6ef;--ink:#2a1512;--muted:#6b5550;--line:rgba(92,1,1,0.16);--accent:#c9502a}
  @media (prefers-color-scheme:dark){:root:not([data-theme="light"]){--bg:#1a120e;--ink:#f5ecdf;--muted:#b49f98;--line:rgba(245,236,223,0.18);--accent:#e0714a}}
  :root[data-theme="dark"]{--bg:#1a120e;--ink:#f5ecdf;--muted:#b49f98;--line:rgba(245,236,223,0.18);--accent:#e0714a}
