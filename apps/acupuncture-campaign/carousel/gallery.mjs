...
writeFileSync(new URL('./review.html', import.meta.url), `<title>Acupuncture Carousels</title>
<style>
  :root{--bg:#faf6ef;--ink:#2a1512;--muted:#6b5550;--line:rgba(92,1,1,0.16);--accent:#a87b2e}
  @media (prefers-color-scheme:dark){:root:not([data-theme="light"]){--bg:#1a120e;--ink:#f5ecdf;--muted:#b49f98;--line:rgba(245,236,223,0.18);--accent:#d9a441}}
  :root[data-theme="dark"]{--bg:#1a120e;--ink:#f5ecdf;--muted:#b49f98;--line:rgba(245,236,223,0.18);--accent:#d9a441}
...
<div class="wrap">
  <h1>Veterinary Acupuncture<br>Twelve carousels, 72 slides</h1>
